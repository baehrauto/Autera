  ...
  return (
    <div className="min-h-screen flex flex-col bg-white text-gray-900 overflow-hidden">
      ...
      <main className="flex-grow">
        {/* Hero */}
        <section className="relative bg-gradient-to-b from-white via-gray-50 to-white pt-20 sm:pt-24 md:pt-32 pb-16 sm:pb-20 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black text-gray-900 mb-6 sm:mb-8 tracking-tight px-4">Our Products</h1>
            <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl text-gray-600 max-w-5xl mx-auto font-light tracking-wide px-4">
        ...
        {/* Products Grid */}
        <section className="py-16 sm:py-20 lg:py-24 bg-gradient-to-b from-white via-gray-50 to-white flex justify-center items-center relative overflow-hidden">
          {/* Subtle Background */}
          ...
          <div className="w-full max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-stretch relative z-10 px-4 sm:px-6 lg:px-8">
            ...
            <div className="group relative bg-white rounded-3xl border border-cyan-200 shadow-xl hover:shadow-2xl hover:border-cyan-400 transition-all duration-500 p-6 sm:p-8 lg:p-10 flex flex-col min-h-[600px] sm:min-h-[700px] lg:min-h-[800px] overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col flex-grow">
                <div className="text-center mb-6 sm:mb-8">
                  <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 bg-gradient-to-br from-cyan-500/20 to-blue-500/20 rounded-2xl mb-4 sm:mb-6 border border-cyan-400/30">
                    <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-gradient-to-r from-cyan-400 to-blue-400 rounded-lg flex items-center justify-center shadow-lg shadow-cyan-400/25">
                      <div className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 bg-white rounded-sm"></div>
                    </div>
                  </div>
                  <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black text-gray-900 mb-3 sm:mb-4 tracking-wider">CUSTOM WEBSITES</h2>
                  ...
                  <p className="text-sm sm:text-base lg:text-xl text-gray-600 font-medium tracking-wide">Bespoke web development tailored to your business needs</p>
                </div>
                
                <div className="flex-grow">
                  <div className="space-y-4 sm:space-y-6 mb-6 sm:mb-8">
                    <div>
                      <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-cyan-600 mb-3 sm:mb-4">What's Included</h3>
                      <ul className="space-y-3 sm:space-y-4 text-sm sm:text-base lg:text-lg text-gray-600">
                ...
                <div className="mt-8 pt-6 border-t border-cyan-200">
                  <div className="text-center mb-6">
                    ...
                    <p className="text-sm text-gray-500 font-medium tracking-wide">Get a personalized quote based on your specific requirements</p>
                  </div>
                  <Link href="/contact" className="block w-full px-6 py-4 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-xl font-bold text-center hover:from-cyan-600 hover:to-blue-600 transition-all duration-300 shadow-xl hover:shadow-cyan-500/25 transform hover:-translate-y-1">
            ...
            <div className="group relative bg-white rounded-3xl border border-purple-200 shadow-xl hover:shadow-2xl hover:border-purple-400 transition-all duration-500 p-10 flex flex-col min-h-[800px] overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col flex-grow">
                <div className="text-center mb-8">
                  ...
                  <h2 className="text-5xl md:text-6xl font-black text-gray-900 mb-4 tracking-wider">
                    <span className="bg-gradient-to-r from-purple-600 via-indigo-600 to-cyan-600 bg-clip-text text-transparent">VOICE<br />AGENTS</span>
                  </h2>
                  ...
                  <p className="text-xl text-gray-600 font-medium tracking-wide">AI-powered voice assistants tailored to your business needs</p>
                </div>
                
                <div className="flex-grow">
                  <div className="space-y-6 mb-8">
                    <div>
                      <h3 className="text-2xl font-bold text-purple-600 mb-4">Capabilities</h3>
                ...
                <div className="mt-8 pt-6 border-t border-purple-200">
                  ...
                  <Link href="/contact" className="block w-full px-6 py-4 bg-gradient-to-r from-purple-500 to-indigo-500 text-white rounded-xl font-bold text-center hover:from-purple-600 hover:to-indigo-600 transition-all duration-300 shadow-xl hover:shadow-purple-500/25 transform hover:-translate-y-1">
        ...
        <section className="bg-gradient-to-br from-white via-gray-50 to-white py-24 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            <h2 className="text-5xl md:text-6xl font-black text-gray-900 mb-8 tracking-tight">Complete Digital Solution</h2>
            ...
            <div className="bg-cyan-50 rounded-3xl p-8 mb-12 border border-cyan-200">
              <h3 className="text-3xl font-bold text-gray-900 mb-4">Website + Voice Agent Bundle</h3>
              <p className="text-xl text-gray-600 mb-6">Everything you need for a complete digital presence</p>
              <div className="text-4xl font-black text-gray-900">
                Custom Pricing
              </div>
              <p className="text-gray-600 text-lg mt-2">Get a personalized quote based on your specific requirements</p>
            </div>
            <Link href="/contact" className="inline-block px-16 py-8 bg-gradient-to-r from-cyan-500 to-purple-500 text-white rounded-3xl font-black text-2xl shadow-xl hover:from-cyan-600 hover:to-purple-600 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-cyan-500/25 tracking-wider">
